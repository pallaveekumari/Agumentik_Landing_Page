    ...
    <Box>
      ...
      <Box className={styles.profilebox}>
        ...
        <Box className={styles.profiletext}>
          ...
          <Text>
            <span className={styles.userdetail}>{userdetails.name}</span>🎯 for
            Troikagency - UX/UI Design Agency • Follow • Hire Us
          </Text>
        </Box>
        <Box className={styles.buttonbox}>
          <Button>Save</Button>
          <Button ml="1rem" colorScheme={"pink"} color="white">
      ...
      <Box className={styles.new}>
        ...
        <Text>
          eMail: <span className={styles.useremail}>{userdetails.email}</span>
        </Text>
      ...
      <Box className={styles.contactcontainer}>
        ...
        <Box className={styles.contactmaindiv}>
          ...
          <Box id="popup" className={styles.popup}>
            <Heading className={styles.poptext}>
